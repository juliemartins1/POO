...
public class Main {
    public static void main(String[] args) {
        ...
        Paciente paciente1 = new Paciente(
            "João", "98765432100", "53988888888","joaoa@gmail.com",
        ...
        Medico medico1 = new Medico("Carla", "12345678900", "53999999999", "CRM1234", "Cardiologia","carla@gmail.com");
        medico1.abrirAgenda(LocalDate.of(2025, 6, 1));

        
        try {
            // 3. Agendando consultas
            LocalDateTime dataHora = LocalDateTime.of(2025, 6, 1, 17, 0);
            ...
            System.out.println("CPF/CRM: " + responsavel.getDocumento());
